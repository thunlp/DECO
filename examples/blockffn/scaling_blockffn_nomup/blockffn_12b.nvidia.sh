...
MOE_ARGS=(
    ...
    --moe-layer-freq '([0]*1+[1]*31)'
    --moe-router-dtype fp32

    --router-act-func relu
    --router-norm-type simple
    --router-norm-init-var 0.1
    --expert-act-func norm_silu
    --expert-act-norm-type normal
    --expert-act-norm-init-var 1.0

    # --moe-router-enable-expert-bias
    --moe-expert-bias-update-method sgd_sign
    --moe-expert-bias-apply-method rms
    --print-expert-bias-step 10
