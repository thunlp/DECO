...
def mup_init_method_normal(sigma, mup_width_scale):
    """Init method based on N(0, sigma/sqrt(model hidden_size / base hidden_size))"""
    std = sigma / math.sqrt(mup_width_scale)
