...
from megatron.core.transformer.blockffn.router_entropy import RouterEntropyAutoScaler
...
def forward_step(
    ...
    if hasattr(config, 'num_moe_experts') and config.num_moe_experts is not None:
        ...
        if config.calculate_per_token_loss:
            ...
            RouterEntropyAutoScaler.set_loss_scale(loss_scale)
        else:
            MoEAuxLossAutoScaler.set_loss_scale(loss_scale / num_microbatches)
            RouterEntropyAutoScaler.set_loss_scale(loss_scale / num_microbatches)
